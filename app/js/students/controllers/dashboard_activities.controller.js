...
(function () {
  ...
  StudentActivitiesCtrl.$inject = ['$scope','$modal','$http','$location','$timeout','$state','Authentication'];
  /**
  * @namespace StudentActivitiesCtrl
  */
  function StudentActivitiesCtrl($scope,$modal,$http,$location,$timeout,$state,Authentication) {

...
module.exports = function(config) {
  config.set({
    ...
    files: [
        ...
        'app/lib/angular-simple-logger/dist/angular-simple-logger.js',
        'app/lib/lodash/lodash.js',
        'app/lib/markerclustererplus/src/markerclusterer.js',
        ...
        'app/lib/moment-timezone/builds/moment-timezone-with-data-2010-2020.min.js',
